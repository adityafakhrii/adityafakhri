    ...
    <TranslatedContent
      renderContent={({ t }) => (
        <div className="container max-w-5xl py-8 px-4 md:px-8">
          <PageHeader title={t('skills')} description={t('k_740f6db1')} />

          <div className="mt-8 space-y-12">
            <ContentBlock title={t('k_a8c6a555')}>
            ...
            <ContentBlock title={t('k_ed0fa7c5')}>
            ...
            <ContentBlock title={t('k_777a5980')}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  <CardContent className="p-6">
                    <h3 className="font-medium mb-4">{t('k_1b12507c')}</h3>
                    <ul className="space-y-3">
                      <li className="flex items-center">
                        <div>
                          <p className="font-medium">{t('k_88aed6f1')}</p>
                      ...
                      <li className="flex items-center">
                        <div>
                          <p className="font-medium">{t('k_9e830288')}</p>
                          <p className="text-sm text-muted-foreground">
                            {t('k_a17cd68e')
                            }
                          </p>
                      ...
                      <li className="flex items-center">
                        <div>
                          <p className="font-medium">{t('k_3d23b24e')}</p>
                          <p className="text-sm text-muted-foreground">
                            {t('k_474b5092')
                            }
                          </p>
                ...
                <Card>
                  <CardContent className="p-6">
                    <h3 className="font-medium mb-4">{t('k_84b4bc27')}</h3>
                    <ul className="space-y-3">
                      <li className="flex items-center">
                        <div>
                          <p className="font-medium">{t('k_6a03a970')}</p>
                          <p className="text-sm text-muted-foreground">
                            {t('k_2b8a0d00')
                            }
                          </p>
                      ...
                      <li className="flex items-center">
                        <div>
                          <p className="font-medium">{t('k_9b9c820d')}</p>
                          <p className="text-sm text-muted-foreground">
                            {t('k_3c4c9c5a')
                            }
                          </p>
                      ...
                      <li className="flex items-center">
                        <div>
                          <p className="font-medium">{t('k_abbac76b')}</p>
                          <p className="text-sm text-muted-foreground">
                            {t('k_6c7954fb')
                            }
                          </p>
                      ...
                      <li className="flex items-center">
                        <div>
                          <p className="font-medium">{t('k_9effde75')}</p>
                          <p className="text-sm text-muted-foreground">
                            {t('k_54eaa39c')
                            }
                          </p>
