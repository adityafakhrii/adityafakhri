...
export default function BlogPage() {
  return (
    <div className="container max-w-5xl py-8 px-4 md:px-8">
      <PageHeader title="Blog" description="Artikel dan tutorial tentang pengembangan web, AI, dan teknologi" />
      ...
      <Tabs defaultValue="all">
        <TabsList className="mb-6">
          ...
          <TabsTrigger value="career">Karir</TabsTrigger>
        </TabsList>
      ...
      <ContentBlock title="📬 Berlangganan Newsletter" className="mt-12">
        <div className="text-center max-w-xl mx-auto">
          <p className="mb-4">
            Dapatkan artikel terbaru dan tips pengembangan langsung ke inbox Anda. Saya mengirim newsletter setiap dua
            minggu dengan konten eksklusif.
          </p>
