...
export const experiences: ExperienceItem[] = [
  {
    ...
    bullets: {
      id: [
        "Merancang dan menyelenggarakan program AI & Fullstack yang berdampak pada 5.000+ peserta didik, meningkatkan tingkat penyelesaian proyek melalui implementasi langsung (hands-on) menggunakan Laravel, JavaScript, dan perangkat AI (Antigravity, Lovable, Bolt, dll.).",
        "Membangun kurikulum yang relevan dengan industri untuk memungkinkan peserta didik merilis proyek web & AI siap produksi, memperkecil kesenjangan antara pembelajaran dan penerapan (learning-to-deployment gap) menggunakan metodologi pembelajaran berbasis proyek.",
        "Memimpin 50+ sesi langsung & workshop (online/offline), menerjemahkan alur kerja AI yang kompleks menjadi sistem praktis, serta meningkatkan kepuasan peserta didik hingga mencapai rating 4.9+/5.",
        "Mengembangkan ekosistem konten multi-platform (YouTube & konten format pendek), meningkatkan interaksi (engagement), dan mempercepat penguasaan keterampilan menggunakan strategi pembelajaran berbasis konten.",
      ],
      en: [
        "Designed and delivered AI & Fullstack programs impacting 5,000+ learners, increasing project completion rate through hands-on implementation using Laravel, JavaScript, and AI tools (Antigravity, Lovable, Bolt, etc.).",
        "Built industry-relevant curricula enabling learners to ship production-ready web & AI projects, reducing learning-to-deployment gap using project-based learning methodology.",
        "Led 50+ live sessions & workshops (online/offline), translating complex AI workflows into practical systems, improving learner satisfaction to 4.9+/5 rating.",
        "Developed multi-platform content ecosystem (YouTube & short-form), boosting engagement and accelerating skill acquisition using content-driven learning strategy.",
      ],
    },
    tags: ["YouTube Video Creation", "Laravel", "Full-Stack Development", "Video Production", "Teaching", "Communication", "AI Tools", "JavaScript", "Project-Based Learning"],
  },
  {
    id: "lead-gdg-campus",
